                ...
                <div className="row ">
                  <div className="col-6">
                    ...
                    <div className="row">
                      ...
                      {moment(this.state.responseData[0]?.deliveryorder.created_at).format("DD-MM-YYYY")} {` `}
                       {moment(this.state.responseData[0]?.deliveryorder.created_at).format("HH:MM:SS")}
                  ...
                  <div className="col-6">
                    ...
                    <div className="row">
                      ...
                      <div className="col-9">
                        : {this.state.responseData[0]?.deliveryorder.contact_person}
                      </div>
                    </div>
                    <div className="row">
