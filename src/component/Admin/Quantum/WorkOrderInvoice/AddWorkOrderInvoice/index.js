        ...
        <div className="quotation-detail">
          <div className="form-group mb-4 pb-2">
            ...
            <div className="row">
              ...
              {localStorage.getItem("tenantIdXero") && disableEdit == true ? (
                <div className="col-md-2 col-12 mt-3">
                  <NormalButton
                    buttonClass={"mx-2"}
                    mainbg={true}
              ...
              {disableEdit == true ? (
                <div className="col-md-3 col-12 mt-3">
                  <a
                    href={`https://login.xero.com/identity/connect/authorize?response_type=code&client_id=${xero.clientId}&redirect_uri=${xero.redirectUrl}&scope=offline_access openid profile email accounting.transactions&state=123`}
                  >
                    <NormalButton
                      buttonClass={"mx-2"}
                      mainbg={true}
